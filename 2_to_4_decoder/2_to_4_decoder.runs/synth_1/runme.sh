...
HD_PWD='C:/Users/Gaurav/2_to_4_decoder/2_to_4_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log f2_to_4_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source f2_to_4_decoder.tcl
